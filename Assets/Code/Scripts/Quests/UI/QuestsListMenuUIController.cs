    ...
    public class QuestsListMenuUIController
    {
        ...
        private void FilterQuests(EQuestType questType)
        {
            ...
            if (questType == EQuestType.SECONDARY)
            {
                ...
                _root.Q<Button>(FILTER_MISSIONS_QUESTS_BUTTON_UI_NAME)
                    .RemoveFromClassList(FILTER_BUTTON_ACTVE_CLASSNAME);
            }
            else
            {
                _root.Q<Button>(FILTER_SECONDARY_QUESTS_BUTTON_UI_NAME)
                    .RemoveFromClassList(FILTER_BUTTON_ACTVE_CLASSNAME);
        ...
        private void OnQuestSelected(AQuestSO quest)
        {
            ...
            _questItemsUIControllers
                .Where(questItemUIController =>
                    questItemUIController.ControlledQuest != quest && questItemUIController.IsSelected)
                .ToList()
