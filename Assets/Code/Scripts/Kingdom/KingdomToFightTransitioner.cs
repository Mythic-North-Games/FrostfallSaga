...
namespace FrostfallSaga.Kingdom
{
	public class KingdomToFightTransitioner : MonoBehaviour
	{
        ...
        [field: SerializeField] public KingdomConfigurationSO KingdomConfiguration { get; private set; }
        ...
        private void PersisteKingdomConfiguration()
        {
            if (KingdomConfiguration == null)
            {
                Debug.LogError("KingdomCOnfigurationSO is null");   
            } else
            {
                KingdomConfiguration.HexGrid = _kingdomManager.KingdomGrid;
                KingdomConfiguration.HeroGroup = _kingdomManager.HeroGroup;
                KingdomConfiguration.EnemiesGroups = _kingdomManager.EnemiesGroups;
                JsonUtility.ToJson(KingdomConfiguration);
