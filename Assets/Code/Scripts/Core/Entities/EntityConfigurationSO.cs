...
namespace FrostfallSaga.Core.Entities
{
    ...
    public class EntityConfigurationSO : ScriptableObject
    {
        ...
        [field: SerializeField] public Sprite InventoryBackgroundIllustration { get; private set; }
        [field: SerializeField] public Sprite InventoryTPoseIllustration { get; private set; }
