...
namespace FrostfallSaga.EditModeTests.Grid.Cells
{
    public class GetNeighborsTests
    {
        ...
        public void GetNeighbors_SomeInaccessible_Even_Test()
        {
            ...
            grid.Cells[new(2, 2)].Setup(new(2, 2), ECellHeight.LOW, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_SomeHeightInaccessible_Even_Test()
        {
            ...
            grid.Cells[new(2, 2)].Setup(new(2, 2), ECellHeight.HIGH, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_LowHeightDifference_Even_Test()
        {
            ...
            grid.Cells[new(2, 2)].Setup(new(2, 2), ECellHeight.MEDIUM, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(3, 1)].Setup(new(3, 1), ECellHeight.MEDIUM, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_Isolated_Even_Test()
        {
            ...
            grid.Cells[new(3, 3)].Setup(new(3, 3), ECellHeight.MEDIUM, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(4, 2)].Setup(new(4, 2), ECellHeight.MEDIUM, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(2, 1)].Setup(new(2, 1), ECellHeight.MEDIUM, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_SomeInaccessible_Odd_Test()
        {
            ...
            grid.Cells[new(4, 3)].Setup(new(4, 3), ECellHeight.LOW, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_SomeHeightInaccessible_Odd_Test()
        {
            ...
            grid.Cells[new(4, 3)].Setup(new(4, 3), ECellHeight.HIGH, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_LowHeightDifference_Odd_Test()
        {
            ...
            grid.Cells[new(4, 3)].Setup(new(4, 3), ECellHeight.MEDIUM, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(2, 3)].Setup(new(2, 3), ECellHeight.MEDIUM, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_Isolated_Odd_Test()
        {
            ...
            grid.Cells[new(4, 3)].Setup(new(4, 3), ECellHeight.HIGH, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(2, 3)].Setup(new(2, 3), ECellHeight.HIGH, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(4, 4)].Setup(new(4, 4), ECellHeight.MEDIUM, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
            ...
            grid.Cells[new(4, 2)].Setup(new(4, 2), ECellHeight.MEDIUM, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(3, 4)].Setup(new(3, 4), ECellHeight.MEDIUM, 2f, CommonTestsHelper.InaccessibleTerrain, CommonTestsHelper.DefaultBiome);
        ...
        public void GetNeighbors_IncludeInaccessible_Test()
        {
            ...
            grid.Cells[new(4, 3)].Setup(new(4, 3), ECellHeight.LOW, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
            grid.Cells[new(2, 3)].Setup(new(2, 3), ECellHeight.LOW, 2f, CommonTestsHelper.AccessibleTerrain, CommonTestsHelper.DefaultBiome);
