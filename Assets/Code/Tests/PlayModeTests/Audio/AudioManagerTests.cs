...
namespace FrostfallSaga.PlayModeTests
{
    public class AudioManagerTests
    {
        ...
        // private UIAudioClips uIAudioClipsConfig;
        ...
        //     uIAudioClipsConfig = ScriptableObject.CreateInstance<UIAudioClips>();
        //     uIAudioClipsConfig.fightBegin = AudioClip.Create("FightBegin", 44100, 1, 44100, false);
        //     uIAudioClipsConfig.buttonClick = AudioClip.Create("ButtonClick", 44100, 1, 44100, false);
        //     uIAudioClipsConfig.buttonHover = AudioClip.Create("ButtonHover", 44100, 1, 44100, false);
        //     uIAudioClipsConfig.fightWon = AudioClip.Create("FightWon", 44100, 1, 44100, false);
        //     uIAudioClipsConfig.fightLost = AudioClip.Create("FightLost", 44100, 1, 44100, false);
